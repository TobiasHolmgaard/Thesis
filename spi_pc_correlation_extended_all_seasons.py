...
# ax = plt.axes(projection=proj)
# ax.coastlines()
# std_norm_precip.where(std_norm_precip < 1.2, drop = True).plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.Greys,
#                          transform=ccrs.PlateCarree(), add_colorbar=False)
# colorbar = plt.colorbar(mappable=std_norm_precip.plot.contourf(ax=ax, levels = clevs, 
#                                                           cmap=plt.cm.Greys, add_colorbar=False), 
#                         ax=ax, orientation='vertical', pad=0.02)
...
ax = plt.axes(projection=proj)
ax.coastlines()
zero_value_mask.plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.Greys,
                         transform=ccrs.PlateCarree(), add_colorbar=False)
colorbar = plt.colorbar(mappable=std_norm_precip.plot.contourf(ax=ax, levels = clevs, 
                                                          cmap=plt.cm.Greys, add_colorbar=False), 
                        ax=ax, orientation='vertical', pad=0.02)
...
std_norm_precip_sort = std_norm_precip.where(zero_value_mask == 1, drop = True)

clevs = np.linspace(0, 2, 9)
proj = ccrs.Orthographic(central_longitude=17.5, central_latitude=50.375)
ax = plt.axes(projection=proj)
ax.coastlines()
std_norm_precip_sort.plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.Greys,
                         transform=ccrs.PlateCarree(), add_colorbar=False)
colorbar = plt.colorbar(mappable=std_norm_precip.plot.contourf(ax=ax, levels = clevs, 
                                                          cmap=plt.cm.Greys, add_colorbar=False), 
                        ax=ax, orientation='vertical', pad=0.02)
...
# if len(months) < 12:
#     z_values = z_values.where(z_values['time.month'].isin(months))
...
eof_res_array_GP = eof_res_array['modes'] * z_values.mean()
...
ax = plt.axes(projection=proj)
ax.coastlines()
plotting_data[15:185,70:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                         transform=ccrs.PlateCarree(), add_colorbar=True)
...
eof_res_array1 = eof_res_array.reindex(time=ERA5_data['time'][months[0]-1:-9])
...
eof_res_array_sf_1 = eof_res_array_sf.reindex(time=ERA5_data['time'][months[0]-1:-9])
...
if months_number > 1:
    ...
    # pcs = pcs_roll_mean
    pcs_roll_mean_sf[nan_mask] = np.nan
...
for i, ax in enumerate(axs[:num_subplots]):
    ...
    clevs_eof = np.linspace(-350, 350, 15)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value regression slopes' + period, fontsize = 43, loc='right', pad=33)
...
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_summer_season.nc')
...
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_extended_summer_season.nc')
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_winter_season.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) +'_month_extended_winter_season.nc')
...
period = str(' All months 1950-2022')
...
for i in eof_res_array['EOF']:
    ...
    eof_res_array['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    plot_text = str(round(varfrac[i-1]*100, 1)) + '%'
    ax.set_title('EOF' + str(eof_res_array['EOF'][i-1].values) + ' GP500 anomaly all months 1950-2022', fontsize=13)
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
...
for i in eof_res_array_sf['EOF']:
    ...
    eof_res_array_sf['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('EOF' + str(eof_res_array_sf['EOF'][i-1].values) + ' MSLP anomaly all months 1950-2022', fontsize=13)
    plot_text = str(round(varfrac_sf[i-1]*100, 1)) + '%'
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficient' + period, fontsize = 39, loc='right', pad=33)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value high correlation coefficients' + period, fontsize = 36, loc='right', pad=33)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value regression slope' + period, fontsize = 42, loc='right', pad=33)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + 
          period, fontsize = 47, loc='right', pad=33)
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_full_year.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_full_year.nc')
