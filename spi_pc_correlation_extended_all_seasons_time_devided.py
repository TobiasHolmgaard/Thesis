# -*- coding: utf-8 -*-
"""
Created on Wed Nov 15 16:15:24 2023
...
### OBS! Can be edited for daily date imput...

time_spi = E_obs['time'][:360]
longitude = E_obs['longitude']#[180:222]
latitude = E_obs['latitude']#[100:142]
precip = E_obs['rr'][:360]#[:,100:142,180:222]
...
ax.set_title('Std for precipitation in gridcells 1950-1979', fontsize=12)
plt.show()
...
ax.set_title('Std normalized precip in gridcells 1950-1979', fontsize=12)
plt.show()
...
spi_monthly_array.to_netcdf('SPI_' + str(months_number) + '_month_1950_1979.nc')
#%%
spi_monthly_array = xr.open_dataset('SPI_' + str(months_number) + '_month_1950_1979.nc')
...
ax.set_title('SPI ' + str(months_number) + ' month - infinite values count', fontsize=16)
plt.show()
...
plotting_data[15:185,105:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                         transform=ccrs.PlateCarree(), add_colorbar=True)
ax.set_title('Mean SPI values ' + str(months_number) + '-month for MJJAS 1976', fontsize=14)
plt.show()
...
for i in eof_res_array['EOF']:
    ...
    ax.set_title('EOF' + str(eof_res_array['EOF'][i-1].values) + ' GP500 anomaly' + period, fontsize=14)
...
for i in eof_res_array_sf['EOF']:
    ...
    eof_res_array_sf['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('EOF' + str(eof_res_array_sf['EOF'][i-1].values) + ' MSLP anomaly' + period, fontsize=14)
...
for i in corr_xr['PC']:
    ...
    corr_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' GP500 and SPI ' + str(months_number) + '-month 50-22 corr', fontsize=14)
    plt.show()

### Calculate the correlations for the MSLP

if months_number > 1:
    pcs_summed_sf = np.cumsum(pcs_sf, axis = 0, dtype=float)
    pcs_summed_roll_sf = pcs_summed_sf.copy()
    pcs_summed_roll_sf[months_number:] = pcs_summed_sf[:-months_number]
    pcs_roll_mean_sf = (pcs_summed_sf - pcs_summed_roll_sf) / months_number
    pcs_sf = pcs_roll_mean_sf
...
for i in corr_sf_xr['PC']:
    ...
    corr_sf_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_sf_xr['PC'][i].values+1) + ' MSLP and SPI ' + str(months_number) + '-month 50-22 corr', fontsize=14)
    plt.show()
...
for i in high_corr_xr['PC']:
    ...
    high_corr_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' GP500 and SPI ' + str(months_number) + '-month 50-22 Hcorr', fontsize=14)
    plt.show()
...
for i in corr_sf_xr['PC']:
    ...
    high_corr_sf_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' MSLP and SPI ' + str(months_number) + '-month 50-22 Hcorr', fontsize=14)
    plt.show()
...
for i in regressions_xr['PC']:
    ...
    regressions_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' Z500 and SPI ' + str(months_number) + '-month 50-22 RegSlope', fontsize=14)
    plt.show()
...
for i in regressions_sf_xr['PC']:
    ...
    regressions_sf_xr[i].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' MSLP and SPI ' + str(months_number) + '-month 50-22 RegSlope', fontsize=14)
    plt.show()
...
for i in corr_xr['PC']:
    ...
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' GP500 and SPI ' + str(months_number) + '-month 50-22 corr', fontsize=13)
    plt.show()
...
for i in corr_sf_xr['PC']:
    ...
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' MSLP and SPI ' + str(months_number) + '-month 50-22 corr', fontsize=13)
    plt.show()
...
for i, ax in enumerate(axs[:num_subplots]):
    ...
    hatches = np.where(mask, hatching_pattern, hatches)
    high_corr_xr[i,15:185,105:345].plot.contourf(ax=ax, levels=clevs, 
                                    cmap=plt.cm.RdBu_r,
                                    transform=ccrs.PlateCarree(), 
                                    hatches = [hatching_pattern], 
                                    add_colorbar=False)
...
for i, ax in enumerate(axs[num_subplots:]):
    ...
    hatches = np.where(mask, hatching_pattern, hatches)
    high_corr_sf_xr[i,15:185,105:345].plot.contourf(ax=ax, levels=clevs, 
                                    cmap=plt.cm.RdBu_r,
                                    transform=ccrs.PlateCarree(), 
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + period, fontsize = 40, loc='right', pad=33)
...
for i in corr_xr['PC']:
    ...
    clevs_eof = np.linspace(-0.007, 0.007, 15)
...
for i, ax in enumerate(axs[:num_subplots]):
    clevs = np.linspace(-1, 1.00, 21)
    ax.coastlines()
    corr_xr[i,15:185,105:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                            transform=ccrs.PlateCarree(), add_colorbar=False)
    mask = high_corr_xr[i,15:185,105:345].notnull()
    hatches = np.full(corr_xr[i,15:185,105:345].shape, '', dtype='U1')
    hatching_pattern = '....'
...
for i, ax in enumerate(axs[num_subplots:]):
    ...
    ax.coastlines()
    ax.coastlines()
    corr_sf_xr[i,15:185,105:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                            transform=ccrs.PlateCarree(), add_colorbar=False)
    mask = high_corr_sf_xr[i,15:185,105:345].notnull()
    hatches = np.full(corr_xr[i,15:185,105:345].shape, '', dtype='U1')
    hatching_pattern = '....'
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + period, fontsize = 51, loc='right', pad=33)
...
for i in regressions_xr['PC']:
    ...
    high_corr_xr[i].plot.contourf(ax=ax, levels=clevs, 
                                    ...
                                    hatches = [hatching_pattern], 
                                    add_colorbar=False)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' GP500 and SPI ' + str(months_number) + '-month 50-22 RegSlope', fontsize=13)
    plt.show()
...
for i in regressions_sf_xr['PC']:
    ...
    high_corr_sf_xr[i].plot.contourf(ax=ax, levels=clevs, 
                                    ...
                                    hatches = [hatching_pattern], 
                                    add_colorbar=False)
    ax.set_title('PC' + str(corr_xr['PC'][i].values+1) + ' MSLP and SPI ' + str(months_number) + '-month 50-22 RegSlope', fontsize=13)
    plt.show()
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value regression slopes' + period, fontsize = 41, loc='right', pad=33)
...
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_summer_1950_1979.nc')
...
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_extended_summer_season_1950_1979.nc')

print('time for winter period calculation')

#%%

### Same process just for winter monthts only
...
plotting_data[15:185,105:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                         transform=ccrs.PlateCarree(), add_colorbar=True)
ax.set_title('Mean SPI values ' + str(months_number) + '-month for NDJFM 1976', fontsize=14)
plt.show()
    ...
    for lat in range(len(lats)):
        for lon in range(len(longs)):
            ...
            if np.isnan(calc_data).any() ==  True:
                ...
                polifit = poly.polyfit(exp_coef[:,i],calc_data,1)
                regressions[i, lat, lon] = polifit[1]
        print('winter 500 hPa regression ' + str(round((x*100/(len(lats)*4)),1)) + ' %')
        x = x+1
    ...
    for lat in range(len(lats)):
        for lon in range(len(longs)):
            ...
            if np.isnan(calc_data).any() ==  True:
                ...
                polifit = poly.polyfit(exp_coef_sf[:,i],calc_data,1)
                regressions_sf[i, lat, lon] = polifit[1]
        print('winter surface regression ' + str(round((x*100/(len(lats)*4)),1)) + '%')
        x = x+1
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value regression slope' + period, fontsize = 44, loc='right', pad=33)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + period, fontsize = 49, loc='right', pad=33)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value regression slopes' + period, fontsize = 42, loc='right', pad=33)
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_winter_1950_1979.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) +'_month_extended_winter_season_1950_1979.nc')

print('time for full year calculation')
...
period = str(' All months 1950-1979')
...
plotting_data[15:185,105:345].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu,
                         transform=ccrs.PlateCarree(), add_colorbar=True)
ax.set_title('Mean SPI values '+ str(months_number) + '-month for the full year 1976', fontsize=13)
plt.show()
...
for i in eof_res_array['EOF']:
    ...
    eof_res_array['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    plot_text = str(round(varfrac[i-1]*100, 1)) + '%'
    ax.set_title('EOF' + str(eof_res_array['EOF'][i-1].values) + ' GP500 anomaly all months 1950-1979', fontsize=13)
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
...
for i in eof_res_array_sf['EOF']:
    ...
    eof_res_array_sf['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('EOF' + str(eof_res_array_sf['EOF'][i-1].values) + ' MSLP anomaly all months 1950-1979', fontsize=13)
    plot_text = str(round(varfrac_sf[i-1]*100, 1)) + '%'
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
    ...
    for lat in range(len(lats)):
        for lon in range(len(longs)):
            ...
            if np.isnan(calc_data).any() ==  True:
                ...
                polifit = poly.polyfit(exp_coef[:,i],calc_data,1)
                regressions[i, lat, lon] = polifit[1]
        print('all year 500 hPa regression ' + str(round((x*100/(len(lats)*4)),1)) + ' %')
        x = x+1
    ...
    for lat in range(len(lats)):
        for lon in range(len(longs)):
            ...
            if np.isnan(calc_data).any() ==  True:
                ...
                polifit = poly.polyfit(exp_coef_sf[:,i],calc_data,1)
                regressions_sf[i, lat, lon] = polifit[1]
        print('all year surface regression ' + str(round((x*100/(len(lats)*4)),1)) + '%')
        x = x+1
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + period, fontsize = 38, loc='right', pad=33)
...
for i, ax in enumerate(axs[:num_subplots]):
    ...
    contour_plot = eof_res_array['modes'][i].plot.contour(ax=ax, levels=clevs_eof,
                             transform=ccrs.PlateCarree(), add_colorbar=False,
                             linewidths = 0.7, linestyles = 
                             ['dashed' if val < 0.000 else 'dotted' if val > 0.000 
                              else 'solid' for val in clevs_eof], 
                             colors ='k', alpha =1)
    ax.clabel(contour_plot, fontsize = 7)
...
plt.title('PCs and ' + str(months_number) + '-months SPI-value correlation coefficients' + 
          period, fontsize = 49, loc='right', pad=33)
...
## Make a combined plot with all EOF's as subplots
num_subplots = 4
...
for i, ax in enumerate(axs[:num_subplots]):
    ...
    high_corr_xr[i,15:185,105:345].plot.contourf(ax=ax, levels=clevs, 
                                    ...
                                    hatches = [hatching_pattern], 
                                    add_colorbar=False)
    ax.set_title(f'PC{corr_sf_xr["PC"][i].values + 1} GP500', fontsize=20)
...
cax1 = fig.add_axes([1, 0.05, 0.02, 0.9])
# Adjust the position and size of the colorbar
colorbar1 = Colorbar(ax=cax1, mappable=corr_xr[0].plot.contourf(levels = clevs, 
                                                                cmap=plt.cm.RdBu_r, 
                                                                add_colorbar=False)
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_full_year_1950_1979.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_full_year_1950_1979.nc')
...
time_spi = E_obs['time'][516:876]
longitude = E_obs['longitude']#[180:222]
latitude = E_obs['latitude']#[100:142]
precip = E_obs['rr'][516:876]#[:,100:142,180:222]
...
colorbar = plt.colorbar(mappable=std_precip.plot.contourf(ax=ax, levels = clevs, 
                        ...
                        ax=ax, orientation='vertical', pad=0.02)
colorbar.set_label('standard deviation (mm)')
ax.set_title('Std for precipitation in gridcells 1993-2022', fontsize=12)
plt.show()
...
colorbar = plt.colorbar(mappable=std_norm_precip.plot.contourf(ax=ax, levels = clevs, 
                        ...
                        ax=ax, orientation='vertical', pad=0.02)
colorbar.set_label('Std / mean (mm)')
ax.set_title('Std normalized precip in gridcells 1993-2022', fontsize=12)
plt.show()
...
os.chdir(r'C:\Users\tojo1\Documents\Speciale\Data\spi_data')
spi_monthly_array.to_netcdf('SPI_' + str(months_number) + '_month_1993_2022.nc')
#%%
spi_monthly_array = xr.open_dataset('SPI_' + str(months_number) + '_month_1993_2022.nc')
...
ERA5_datas = xr.load_dataset('ERA5_MSLP_50_2023.grib', engine = 'cfgrib')
# Extract geopotential from datafile
sp_values = ERA5_datas['msl'][516:876]
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_summer_1993_2022.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_extended_summer_season_1993_2022.nc')
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_extended_winter_1993_2022.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) +'_month_extended_winter_season_1993_2022.nc')
...
period = str(' All months 1993-2022')
...
for i in eof_res_array['EOF']:
    ...
    eof_res_array['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    plot_text = str(round(varfrac[i-1]*100, 1)) + '%'
    ax.set_title('EOF' + str(eof_res_array['EOF'][i-1].values) + ' GP500 anomaly all months 1993-2022', fontsize=13)
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
...
for i in eof_res_array_sf['EOF']:
    ...
    eof_res_array_sf['modes'][i-1].plot.contourf(ax=ax, levels=clevs, cmap=plt.cm.RdBu_r,
                             transform=ccrs.PlateCarree(), add_colorbar=True)
    ax.set_title('EOF' + str(eof_res_array_sf['EOF'][i-1].values) + ' MSLP anomaly all months 1993-2022', fontsize=13)
    plot_text = str(round(varfrac_sf[i-1]*100, 1)) + '%'
    plt.text(-5100000, -4800000, plot_text, fontsize=12, color='black')
    plt.show()
...
eof_res_array['corr'] = corr_xr_edit
eof_res_array['reg'] = regressions_xr_edit
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_full_year_1993_2022.nc')
...
eof_res_array_sf['corr'] = corr_sf_xr_edit
eof_res_array_sf['reg'] = regressions_sf_xr_edit
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_full_year_1993_2022.nc')
