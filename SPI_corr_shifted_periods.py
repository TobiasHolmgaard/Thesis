...
plt.title('PCs for MAM and SPI-'+ str(months_number) + ' JJA correlation coefficients and EOF analysis', fontsize = 54, loc='right', pad=33)
...
eof_res_array.to_netcdf('500hPa_correlation_analysis_' + str(months_number) + '_month_'+ period + '_shift.nc')
...
eof_res_array_sf.to_netcdf('MSLP_correlation_analysis_' + str(months_number) + '_month_'+ period + '_shift.nc')
